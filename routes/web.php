...
Route::group(['middleware' => ['loginAccess']], function() {
    ...
    Route::post('instituicao/clientes', [InstituicaoController::class, 'store'])->name('instituicao.clientes');
    Route::delete('instituicao/clientes/{id}', [InstituicaoController::class, 'delete'])->name('instituicao.clientes.delete');
