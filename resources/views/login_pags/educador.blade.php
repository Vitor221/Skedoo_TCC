...
<div class="flex-cards">
    ...
    <x-card-funcoes tituloCard="Refeição" href="{{route('educador.refeicao')}}" icon="uil uil-crockery"/>
...
<div class="flex-cards" style="margin-bottom: 0px;">
    <x-card-funcoes tituloCard="Saúde" href="{{route('educador.problemassaude')}}" icon="uil uil-band-aid"/>
